...
#define RTK_RG_MAC_PORT_CPU RTK_RG_MAC_PORT_iNIC		// for compiling
#define RTK_RG_PORT_CPU RTK_RG_PORT_iNIC				// for compiling
...
typedef enum rtk_rg_err_code_e
{
	...
	RT_ERR_RG_SR_TO_DROP,					//Static Route to nexthop IP which leads to DROP
...
#else
	unsigned int route_idx:3;		//v4 or v6
	unsigned int nxtip_rtidx:3;		//v4 or v6, used for autolearn
	unsigned int nxtip_intfidx:3;	//v4 or v6, used for autolearn
#endif
...
typedef struct rtk_rg_globalKernel_s
{
	...
	rtk_rg_wq_union_t		 rg_cbUnionArray[MAX_CALLBACK_UNION_NUM];
