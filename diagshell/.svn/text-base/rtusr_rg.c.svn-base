...
{
    rtdrv_rg_dsliteMcTable_set_t cfg;

    /* parameter check */
    RT_PARAM_CHK((NULL == pDsliteMcEntry), RT_ERR_NULL_POINTER);

    /* function body */
    osal_memcpy(&cfg.pDsliteMcEntry, pDsliteMcEntry, sizeof(rtk_l34_dsliteMc_entry_t));
    GETSOCKOPT(RTDRV_RG_DSLITEMCTABLE_SET, &cfg, rtdrv_rg_dsliteMcTable_set_t, 1);
    osal_memcpy(pDsliteMcEntry, &cfg.pDsliteMcEntry, sizeof(rtk_l34_dsliteMc_entry_t));

    return RT_ERR_OK;
}   /* end of rtk_rg_dsliteMcTable_set */
...
{
    rtdrv_rg_dsliteMcTable_get_t cfg;
    ...
    /* function body */
    osal_memcpy(&cfg.pDsliteMcEntry, pDsliteMcEntry, sizeof(rtk_l34_dsliteMc_entry_t));
    GETSOCKOPT(RTDRV_RG_DSLITEMCTABLE_GET, &cfg, rtdrv_rg_dsliteMcTable_get_t, 1);
    osal_memcpy(pDsliteMcEntry, &cfg.pDsliteMcEntry, sizeof(rtk_l34_dsliteMc_entry_t));

    return RT_ERR_OK;
}   /* end of rtk_rg_dsliteMcTable_get */
...
{
    rtdrv_rg_dsliteControl_set_t cfg;

    /* function body */
    osal_memcpy(&cfg.ctrlType, &ctrlType, sizeof(rtk_l34_dsliteCtrlType_t));
    osal_memcpy(&cfg.act, &act, sizeof(uint32));
    SETSOCKOPT(RTDRV_RG_DSLITECONTROL_SET, &cfg, rtdrv_rg_dsliteControl_set_t, 1);

    return RT_ERR_OK;
}   /* end of rtk_rg_dsliteControl_set */
...
{
    rtdrv_rg_dsliteControl_get_t cfg;
    ...
    /* function body */
    osal_memcpy(&cfg.ctrlType, &ctrlType, sizeof(rtk_l34_dsliteCtrlType_t));
    osal_memcpy(&cfg.pAct, pAct, sizeof(uint32));
    GETSOCKOPT(RTDRV_RG_DSLITECONTROL_GET, &cfg, rtdrv_rg_dsliteControl_get_t, 1);
    osal_memcpy(pAct, &cfg.pAct, sizeof(uint32));

    return RT_ERR_OK;
}   /* end of rtk_rg_dsliteControl_get */
...
rtk_rg_interfaceMibCounter_get(rtk_l34_mib_t *pMibCnt)
{
    ...
    /* parameter check */
    RT_PARAM_CHK((NULL == pMibCnt), RT_ERR_NULL_POINTER);

    /* function body */
    osal_memcpy(&cfg.pMibCnt, pMibCnt, sizeof(rtk_l34_mib_t));
    GETSOCKOPT(RTDRV_RG_INTERFACEMIBCOUNTER_GET, &cfg, rtdrv_rg_interfaceMibCounter_get_t, 1);
    osal_memcpy(pMibCnt, &cfg.pMibCnt, sizeof(rtk_l34_mib_t));
