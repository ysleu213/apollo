...
#if defined(CONFIG_RTL9602C_SERIES) || defined(CONFIG_RTL9607B_SERIES)
...
#define RTK_RG_MAX_EXT_PORT (RTK_RG_PORT_MAX - RTK_RG_PORT_MASTERCPU_CORE1)
#define RTK_RG_ALL_MAC_PORTMASK ((1<<RTK_RG_MAC_PORT_MAX) - 1)
#define RTK_RG_ALL_MAC_PORTMASK_WITHOUT_CPU (((1<<RTK_RG_MAC_PORT_MAX) - 1) & ~(1<<RTK_RG_PORT_SLAVECPU) && ~(1<<RTK_RG_PORT_MASTERCPU_CORE0) && ~(1<<RTK_RG_PORT_MASTERCPU_CORE1))
...
#define RTK_RG_ALL_VIRUAL_PORTMASK (1|(1<<(RTK_RG_EXT_PORT0-RTK_RG_PORT_MASTERCPU_CORE1))|(1<<(RTK_RG_EXT_PORT1-RTK_RG_PORT_MASTERCPU_CORE1))|(1<<(RTK_RG_EXT_PORT2-RTK_RG_PORT_MASTERCPU_CORE1))|(1<<(RTK_RG_EXT_PORT3-RTK_RG_PORT_MASTERCPU_CORE1))|(1<<(RTK_RG_EXT_PORT4-RTK_RG_PORT_CPU))|(1<<(RTK_RG_EXT_PORT5-RTK_RG_PORT_CPU)))
#define RTK_RG_ALL_USED_VIRUAL_PORTMASK (1|(1<<(RTK_RG_EXT_PORT0-RTK_RG_PORT_MASTERCPU_CORE1))|(1<<(RTK_RG_EXT_PORT1-RTK_RG_PORT_MASTERCPU_CORE1)))
...
#if defined(CONFIG_RTL9602C_SERIES) || defined(CONFIG_RTL9600_SERIES) || defined(CONFIG_RTL9607B_SERIES)
...
#define MAX_CALLBACK_UNION_NUM				32
